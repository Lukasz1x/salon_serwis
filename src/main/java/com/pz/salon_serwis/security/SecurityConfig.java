    ...
    public SecurityFilterChain securityFilterChain(
        ...
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.POST, "api/salonAppointments/**").hasRole("CLIENT")
                        .requestMatchers("api/salonReport/**").hasRole("SALES_REP")
                        .requestMatchers(HttpMethod.POST, "api/serviceAppointments/**").hasRole("CLIENT")
                        .requestMatchers("api/serviceReport/**").hasRole("MECHANIC")
                        .requestMatchers(HttpMethod.POST, "api/salesOrder/**").hasRole("SALES_REP")
                        .requestMatchers(HttpMethod.POST, "api/repairOrder/**").hasRole("MECHANIC")
